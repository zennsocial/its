...
respond "*" "(load 'ioc)"
expect -re {[0-7]}
respond "\n" "(setq clogo t /11logo nil)"
respond "NIL" "(load 'define)"
respond "T" "(maklap)"
respond "_" "define\r"
respond "_" "\032"
type ":kill\r"
...
respond "*" ":lisp\r"
respond "Alloc?" "n"
respond "*" "(setq clogo t /11logo nil)"
respond "NIL" "(load 'loader)"
respond "?" "Y\r"
respond "?" "CLLOGO\r"
respond "?" "1700\r"
expect ":KILL"

respond "*" ":delete define fasl\r"
respond "*" ":delete error fasl\r"
respond "*" ":delete parser fasl\r"
respond "*" ":delete primit fasl\r"
respond "*" ":delete print fasl\r"
respond "*" ":delete reader fasl\r"
respond "*" ":delete setup fasl\r"
respond "*" ":delete unedit fasl\r"

# Lisp Logo, 11LOGO compatible
respond "*" ":complr\r"
respond "_" "\007"
respond "*" "(load 'ioc)"
expect -re {[0-7]}
...
respond "*" ":lisp\r"
respond "Alloc?" "n"
respond "*" "(setq clogo t)"
respond "T" "(load 'loader)"
respond "?" "Y\r"
respond "?" "CLLOGO\r"
respond "?" "1700\r"
expect ":KILL"
...
respond "*" ":link sys1; ts cllogo, llogo; ts cllogo\r"
